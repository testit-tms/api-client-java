...
API
- API version: v2.0
  - Build date: 2022-07-12T16:29:55.695125+03:00[Europe/Moscow]
...
```groovy
compile "ru.testit:testit-api-client:0.1"
```
...
* `target/testit-api-client-0.1.jar`
* `target/lib/*.jar`
...
## Documentation for Models
 ...
 - [AutoTestAverageDurationModel](docs/AutoTestAverageDurationModel.md)
 ...
 - [AutoTestNamespaceModel](docs/AutoTestNamespaceModel.md)
 - [AutoTestPostModel](docs/AutoTestPostModel.md)
 - [AutoTestPutModel](docs/AutoTestPutModel.md)
 - [AutoTestResultPostModel](docs/AutoTestResultPostModel.md)
 ...
 - [ImageResizeOption](docs/ImageResizeOption.md)
 - [IterationModel](docs/IterationModel.md)
 - [IterationPutModel](docs/IterationPutModel.md)
 - [LabelPostModel](docs/LabelPostModel.md)
 ...
 - [ParameterPostModel](docs/ParameterPostModel.md)
 - [ParameterPutModel](docs/ParameterPutModel.md)
 - [ParameterShortModel](docs/ParameterShortModel.md)
 - [ProblemDetails](docs/ProblemDetails.md)
 - [ProjectExportQueryModel](docs/ProjectExportQueryModel.md)
 - [ProjectExportWithTestPlansPostModel](docs/ProjectExportWithTestPlansPostModel.md)
 - [ProjectIdImportBody](docs/ProjectIdImportBody.md)
 - [ProjectModel](docs/ProjectModel.md)
 - [ProjectPostModel](docs/ProjectPostModel.md)
 - [ProjectPutModel](docs/ProjectPutModel.md)
 ...
 - [TagShortModel](docs/TagShortModel.md)
 - [TestPlanModel](docs/TestPlanModel.md)
 - [TestPlanPostModel](docs/TestPlanPostModel.md)
 - [TestPlanPutModel](docs/TestPlanPutModel.md)
 ...
 - [TestResultHistoryReportModel](docs/TestResultHistoryReportModel.md)
 - [TestResultIdAttachmentsBody](docs/TestResultIdAttachmentsBody.md)
 - [TestResultV2GetModel](docs/TestResultV2GetModel.md)
 - [TestResultV2ShortModel](docs/TestResultV2ShortModel.md)
 - [TestRunFillByAutoTestsPostModel](docs/TestRunFillByAutoTestsPostModel.md)
 - [TestRunFillByConfigurationsPostModel](docs/TestRunFillByConfigurationsPostModel.md)
 - [TestRunFillByWorkItemsPostModel](docs/TestRunFillByWorkItemsPostModel.md)
 - [TestRunShortModel](docs/TestRunShortModel.md)
 - [TestRunStateTypeModel](docs/TestRunStateTypeModel.md)
 - [TestRunV2GetModel](docs/TestRunV2GetModel.md)
 - [TestRunV2PostShortModel](docs/TestRunV2PostShortModel.md)
 - [TestRunV2PutModel](docs/TestRunV2PutModel.md)
 ...
 - [TestSuiteV2TreeModel](docs/TestSuiteV2TreeModel.md)
 - [V2AttachmentsBody](docs/V2AttachmentsBody.md)
 ...
 - [WorkItemIdModel](docs/WorkItemIdModel.md)
 - [WorkItemModel](docs/WorkItemModel.md)
 - [WorkItemPostModel](docs/WorkItemPostModel.md)
 - [WorkItemPriorityModel](docs/WorkItemPriorityModel.md)
 - [WorkItemPutModel](docs/WorkItemPutModel.md)
