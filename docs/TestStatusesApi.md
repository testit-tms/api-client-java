...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TestStatusesApi#apiV2TestStatusesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    TestStatusesApi apiInstance = new TestStatusesApi(defaultClient);
    TestStatusCreateModel testStatusCreateModel = new TestStatusCreateModel(); // TestStatusCreateModel | 
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    TestStatusesApi apiInstance = new TestStatusesApi(defaultClient);
    TestStatusUpdateModel testStatusUpdateModel = new TestStatusUpdateModel(); // TestStatusUpdateModel | 
    try {
      apiInstance.apiV2TestStatusesPut(testStatusUpdateModel);
    } catch (ApiException e) {
      System.err.println("Exception when calling TestStatusesApi#apiV2TestStatusesPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
