...
public class AttachmentsApi {
   ...
   */
  public void apiV2AttachmentsIdGet(UUID id, Integer width, Integer height, ImageResizeType resizeType, String backgroundColor, Boolean preview) throws ApiException {
   ...
   */
  public ApiResponse<Void> apiV2AttachmentsIdGetWithHttpInfo(UUID id, Integer width, Integer height, ImageResizeType resizeType, String backgroundColor, Boolean preview) throws ApiException {
    // Check required parameters
    if (id == null) {
   ...
   */
  public AttachmentModel apiV2AttachmentsIdMetadataGet(UUID id) throws ApiException {
    return apiV2AttachmentsIdMetadataGetWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<AttachmentModel> apiV2AttachmentsIdMetadataGetWithHttpInfo(UUID id) throws ApiException {
    // Check required parameters
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV2AttachmentsIdMetadataGet");
    }

    // Path parameters
    String localVarPath = "/api/v2/attachments/{id}/metadata"
            .replaceAll("\\{id}", apiClient.escapeString(id.toString()));
