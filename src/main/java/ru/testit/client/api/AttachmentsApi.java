...
public class AttachmentsApi {
     ...
     */
    public okhttp3.Call apiV2AttachmentsIdGetAsync(UUID id, Integer width, Integer height, ImageResizeType resizeType, String backgroundColor, Boolean preview, final ApiCallback<Void> _callback) throws ApiException {
    ...
    /**
     * Build call for apiV2AttachmentsIdMetadataGet
     * @param id  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call apiV2AttachmentsIdMetadataGetCall(UUID id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV2AttachmentsIdMetadataGetValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling apiV2AttachmentsIdMetadataGet(Async)");
        }

        return apiV2AttachmentsIdMetadataGetCall(id, _callback);
    ...
    public AttachmentModel apiV2AttachmentsIdMetadataGet(UUID id) throws ApiException {
        ApiResponse<AttachmentModel> localVarResp = apiV2AttachmentsIdMetadataGetWithHttpInfo(id);
    ...
    public ApiResponse<AttachmentModel> apiV2AttachmentsIdMetadataGetWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = apiV2AttachmentsIdMetadataGetValidateBeforeCall(id, null);
     ...
     */
    public okhttp3.Call apiV2AttachmentsIdMetadataGetAsync(UUID id, final ApiCallback<AttachmentModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV2AttachmentsIdMetadataGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<AttachmentModel>(){}.getType();
