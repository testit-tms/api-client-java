...
public class AutoTestsApi {
   ...
   */
  public void linkAutoTestToWorkItem(String id, WorkItemIdApiModel workItemIdApiModel) throws ApiException {
   ...
   */
  public ApiResponse<Void> linkAutoTestToWorkItemWithHttpInfo(String id, WorkItemIdApiModel workItemIdApiModel) throws ApiException {
    // Check required parameters
    if (id == null) {
