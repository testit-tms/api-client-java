...
public class BackgroundJobsApi {
   ...
   */
  public void apiV2BackgroundJobsCompletedDelete() throws ApiException {
  ...
  public List<BackgroundJobGetModel> apiV2BackgroundJobsGet(Integer skip, Integer take, String orderBy, String searchField, String searchValue) throws ApiException {
    return apiV2BackgroundJobsGetWithHttpInfo(skip, take, orderBy, searchField, searchValue).getData();
  }
  ...
  public ApiResponse<Void> apiV2BackgroundJobsIdCancelPostWithHttpInfo(UUID id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV2BackgroundJobsIdCancelPost");
    }
  ...
  public BackgroundJobGetModel apiV2BackgroundJobsIdGet(UUID id) throws ApiException {
    return apiV2BackgroundJobsIdGetWithHttpInfo(id).getData();
  }
  ...
  public ApiResponse<BackgroundJobGetModel> apiV2BackgroundJobsIdGetWithHttpInfo(UUID id) throws ApiException {
    // Check required parameters
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV2BackgroundJobsIdGet");
    }
  ...
  public BackgroundJobState apiV2BackgroundJobsIdStatusGet(UUID id) throws ApiException {
    return apiV2BackgroundJobsIdStatusGetWithHttpInfo(id).getData();
  }
  ...
  public ApiResponse<BackgroundJobState> apiV2BackgroundJobsIdStatusGetWithHttpInfo(UUID id) throws ApiException {
    // Check required parameters
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV2BackgroundJobsIdStatusGet");
    }
  ...
  public List<BackgroundJobGetModel> apiV2BackgroundJobsSearchPost(Integer skip, Integer take, String orderBy, String searchField, String searchValue, BackgroundJobFilterModel backgroundJobFilterModel) throws ApiException {
    return apiV2BackgroundJobsSearchPostWithHttpInfo(skip, take, orderBy, searchField, searchValue, backgroundJobFilterModel).getData();
  }
