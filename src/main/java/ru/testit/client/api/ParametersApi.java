...
public class ParametersApi {
  ...
  public List<ParameterApiResult> apiV2ParametersBulkPost(List<CreateParameterApiModel> createParameterApiModel) throws ApiException {
    return apiV2ParametersBulkPostWithHttpInfo(createParameterApiModel).getData();
  }
  ...
  public List<ParameterGroupApiResult> apiV2ParametersGroupsGet(Set<UUID> parameterKeyIds, String name, Boolean isDeleted, List<UUID> projectIds, Integer skip, Integer take, String orderBy, String searchField, String searchValue) throws ApiException {
    return apiV2ParametersGroupsGetWithHttpInfo(parameterKeyIds, name, isDeleted, projectIds, skip, take, orderBy, searchField, searchValue).getData();
  }
  ...
  public ApiResponse<List<ParameterGroupApiResult>> apiV2ParametersGroupsGetWithHttpInfo(Set<UUID> parameterKeyIds, String name, Boolean isDeleted, List<UUID> projectIds, Integer skip, Integer take, String orderBy, String searchField, String searchValue) throws ApiException {
    ...
    List<Pair> localVarQueryParams = new ArrayList<>(
            apiClient.parameterToPairs("multi", "parameterKeyIds", parameterKeyIds)
    );
   ...
   */
  @Deprecated
  public List<String> apiV2ParametersKeysGet(List<UUID> projectIds, Integer skip, Integer take, String orderBy, String searchField, String searchValue) throws ApiException {
    return apiV2ParametersKeysGetWithHttpInfo(projectIds, skip, take, orderBy, searchField, searchValue).getData();
  }
   ...
   */
  @Deprecated
  public ApiResponse<List<String>> apiV2ParametersKeysGetWithHttpInfo(List<UUID> projectIds, Integer skip, Integer take, String orderBy, String searchField, String searchValue) throws ApiException {
    // Query parameters
    List<Pair> localVarQueryParams = new ArrayList<>(
            apiClient.parameterToPairs("multi", "projectIds", projectIds)
    );
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "Skip", skip));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "Take", take));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "OrderBy", orderBy));
  ...
  public List<ParameterGroupApiResult> apiV2ParametersSearchGroupsPost(Integer skip, Integer take, String orderBy, String searchField, String searchValue, ParameterGroupsFilterApiModel parameterGroupsFilterApiModel) throws ApiException {
    return apiV2ParametersSearchGroupsPostWithHttpInfo(skip, take, orderBy, searchField, searchValue, parameterGroupsFilterApiModel).getData();
  }
  ...
  public List<ParameterApiResult> apiV2ParametersSearchPost(Integer skip, Integer take, String orderBy, String searchField, String searchValue, ParametersFilterApiModel parametersFilterApiModel) throws ApiException {
    return apiV2ParametersSearchPostWithHttpInfo(skip, take, orderBy, searchField, searchValue, parametersFilterApiModel).getData();
  }
  ...
  public ParameterApiResult createParameter(CreateParameterApiModel createParameterApiModel) throws ApiException {
    return createParameterWithHttpInfo(createParameterApiModel).getData();
  }
