...
import ru.testit.client.model.AutoTestResultReasonProjectApiResult;
...
public class ProjectsApi {
   ...
   * @return List&lt;AutoTestResultReasonProjectApiResult&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public List<AutoTestResultReasonProjectApiResult> apiV2ProjectsIdFailureClassesGet(String id, Boolean isDeleted) throws ApiException {
   ...
   * @param id Unique or global ID of the project (required)
   * @param isDeleted  (optional)
   * @return ApiResponse&lt;List&lt;AutoTestResultReasonProjectApiResult&gt;&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<List<AutoTestResultReasonProjectApiResult>> apiV2ProjectsIdFailureClassesGetWithHttpInfo(String id, Boolean isDeleted) throws ApiException {
    // Check required parameters
    if (id == null) {
    ...
    String localVarContentType = apiClient.selectHeaderContentType();
    String[] localVarAuthNames = new String[] {"Bearer or PrivateToken"};
    GenericType<List<AutoTestResultReasonProjectApiResult>> localVarReturnType = new GenericType<List<AutoTestResultReasonProjectApiResult>>() {};
