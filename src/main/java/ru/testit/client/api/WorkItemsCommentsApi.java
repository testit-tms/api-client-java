...
public class WorkItemsCommentsApi {
    ...
    /**
     * Build call for apiV2WorkItemsIdCommentsCountGet
     ...
     */
    public okhttp3.Call apiV2WorkItemsIdCommentsCountGetCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV2WorkItemsIdCommentsCountGetValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling apiV2WorkItemsIdCommentsCountGet(Async)");
        }

        return apiV2WorkItemsIdCommentsCountGetCall(id, _callback);
    ...
    public Integer apiV2WorkItemsIdCommentsCountGet(String id) throws ApiException {
        ApiResponse<Integer> localVarResp = apiV2WorkItemsIdCommentsCountGetWithHttpInfo(id);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Integer> apiV2WorkItemsIdCommentsCountGetWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = apiV2WorkItemsIdCommentsCountGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get work item comments count (asynchronously)
     * 
     * @param id Unique or global ID of the work item (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call apiV2WorkItemsIdCommentsCountGetAsync(String id, final ApiCallback<Integer> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV2WorkItemsIdCommentsCountGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
