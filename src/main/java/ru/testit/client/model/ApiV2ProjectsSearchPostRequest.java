 ...
 */
@JsonPropertyOrder({
  ApiV2ProjectsSearchPostRequest.JSON_PROPERTY_NAME,
  ApiV2ProjectsSearchPostRequest.JSON_PROPERTY_IS_FAVORITE,
  ApiV2ProjectsSearchPostRequest.JSON_PROPERTY_IS_DELETED,
  ApiV2ProjectsSearchPostRequest.JSON_PROPERTY_TEST_CASES_COUNT,
  ApiV2ProjectsSearchPostRequest.JSON_PROPERTY_CHECKLISTS_COUNT,
  ApiV2ProjectsSearchPostRequest.JSON_PROPERTY_SHARED_STEPS_COUNT,
  ApiV2ProjectsSearchPostRequest.JSON_PROPERTY_AUTOTESTS_COUNT,
  ApiV2ProjectsSearchPostRequest.JSON_PROPERTY_GLOBAL_IDS,
  ApiV2ProjectsSearchPostRequest.JSON_PROPERTY_CREATED_DATE,
  ApiV2ProjectsSearchPostRequest.JSON_PROPERTY_CREATED_BY_IDS
})
@JsonTypeName("_api_v2_projects_search_post_request")
...
public class ApiV2ProjectsSearchPostRequest {
  ...
  **/
  ...
  /**
   * Return true if this _api_v2_projects_search_post_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, apiV2ProjectsSearchPostRequest.name) &&
        equalsNullable(this.isFavorite, apiV2ProjectsSearchPostRequest.isFavorite) &&
        equalsNullable(this.isDeleted, apiV2ProjectsSearchPostRequest.isDeleted) &&
        equalsNullable(this.testCasesCount, apiV2ProjectsSearchPostRequest.testCasesCount) &&
        equalsNullable(this.checklistsCount, apiV2ProjectsSearchPostRequest.checklistsCount) &&
        equalsNullable(this.sharedStepsCount, apiV2ProjectsSearchPostRequest.sharedStepsCount) &&
        equalsNullable(this.autotestsCount, apiV2ProjectsSearchPostRequest.autotestsCount) &&
        equalsNullable(this.globalIds, apiV2ProjectsSearchPostRequest.globalIds) &&
        equalsNullable(this.createdDate, apiV2ProjectsSearchPostRequest.createdDate) &&
        equalsNullable(this.createdByIds, apiV2ProjectsSearchPostRequest.createdByIds);
  }
