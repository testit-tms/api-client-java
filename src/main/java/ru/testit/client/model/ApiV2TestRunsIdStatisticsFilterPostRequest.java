 ...
 */
@JsonPropertyOrder({
  ApiV2TestRunsIdStatisticsFilterPostRequest.JSON_PROPERTY_CONFIGURATION_IDS,
  ApiV2TestRunsIdStatisticsFilterPostRequest.JSON_PROPERTY_OUTCOMES,
  ApiV2TestRunsIdStatisticsFilterPostRequest.JSON_PROPERTY_FAILURE_CATEGORIES,
  ApiV2TestRunsIdStatisticsFilterPostRequest.JSON_PROPERTY_NAMESPACE,
  ApiV2TestRunsIdStatisticsFilterPostRequest.JSON_PROPERTY_CLASS_NAME
})
@JsonTypeName("_api_v2_testRuns__id__statistics_filter_post_request")
...
public class ApiV2TestRunsIdStatisticsFilterPostRequest {
  ...
  **/
  ...
  /**
   * Return true if this _api_v2_testRuns__id__statistics_filter_post_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.configurationIds, apiV2TestRunsIdStatisticsFilterPostRequest.configurationIds) &&
        equalsNullable(this.outcomes, apiV2TestRunsIdStatisticsFilterPostRequest.outcomes) &&
        equalsNullable(this.failureCategories, apiV2TestRunsIdStatisticsFilterPostRequest.failureCategories) &&
        equalsNullable(this.namespace, apiV2TestRunsIdStatisticsFilterPostRequest.namespace) &&
        equalsNullable(this.className, apiV2TestRunsIdStatisticsFilterPostRequest.className);
  }
