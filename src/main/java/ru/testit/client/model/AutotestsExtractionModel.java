...
public class AutotestsExtractionModel {
  ...
  private JsonNullable<AutotestsExtractionModelIds> ids = JsonNullable.<AutotestsExtractionModelIds>undefined();

  public AutotestsExtractionModel() { 
  }

  public AutotestsExtractionModel ids(AutotestsExtractionModelIds ids) {
    this.ids = JsonNullable.<AutotestsExtractionModelIds>of(ids);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<AutotestsExtractionModelIds> getIds_JsonNullable() {
    return ids;
  }
  
  @JsonProperty(JSON_PROPERTY_IDS)
  public void setIds_JsonNullable(JsonNullable<AutotestsExtractionModelIds> ids) {
    this.ids = ids;
  }
