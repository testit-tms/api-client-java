...
public class AutotestsExtractionModelIds {
  ...
  public AutotestsExtractionModelIds() {
  }

  public AutotestsExtractionModelIds include(Set<UUID> include) {
    
    this.include = include;
    return this;
  }

  public AutotestsExtractionModelIds addIncludeItem(UUID includeItem) {
  ...
  **/
  ...
  public AutotestsExtractionModelIds exclude(Set<UUID> exclude) {
    
    this.exclude = exclude;
    return this;
  }

  public AutotestsExtractionModelIds addExcludeItem(UUID excludeItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AutotestsExtractionModelIds autotestsExtractionModelIds = (AutotestsExtractionModelIds) o;
    return Objects.equals(this.include, autotestsExtractionModelIds.include) &&
        Objects.equals(this.exclude, autotestsExtractionModelIds.exclude);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutotestsExtractionModelIds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutotestsExtractionModelIds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutotestsExtractionModelIds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutotestsExtractionModelIds.class));

       return (TypeAdapter<T>) new TypeAdapter<AutotestsExtractionModelIds>() {
           @Override
           public void write(JsonWriter out, AutotestsExtractionModelIds value) throws IOException {
 ...
 /**
  * Create an instance of AutotestsExtractionModelIds given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutotestsExtractionModelIds
  * @throws IOException if the JSON string is invalid with respect to AutotestsExtractionModelIds
  */
  public static AutotestsExtractionModelIds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutotestsExtractionModelIds.class);
  }

 /**
  * Convert an instance of AutotestsExtractionModelIds to an JSON string
  *
  * @return JSON string
  */
