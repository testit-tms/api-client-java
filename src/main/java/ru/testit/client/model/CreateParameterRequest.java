 ...
 */
@JsonPropertyOrder({
  CreateParameterRequest.JSON_PROPERTY_VALUE,
  CreateParameterRequest.JSON_PROPERTY_NAME
})
@JsonTypeName("CreateParameter_request")
...
public class CreateParameterRequest {
  ...
  **/
  ...
  /**
   * Return true if this CreateParameter_request object is equal to o.
   */
  @Override
