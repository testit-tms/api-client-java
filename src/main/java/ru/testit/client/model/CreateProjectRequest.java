  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, createProjectRequest.description) &&
        ...
        Objects.equals(this.isFavorite, createProjectRequest.isFavorite) &&
        Objects.equals(this.isFlakyAuto, createProjectRequest.isFlakyAuto);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateProjectRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProjectRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
