...
public class CreateSectionRequest {
  ...
  public CreateSectionRequest name(String name) {
  ...
  **/
  ...
  public CreateSectionRequest projectId(UUID projectId) {
  ...
  **/
  ...
  public CreateSectionRequest parentId(UUID parentId) {
  ...
  **/
  ...
  public CreateSectionRequest preconditionSteps(List<StepPostModel> preconditionSteps) {
    
    this.preconditionSteps = preconditionSteps;
    return this;
  }

  public CreateSectionRequest addPreconditionStepsItem(StepPostModel preconditionStepsItem) {
  ...
  **/
  ...
  public CreateSectionRequest postconditionSteps(List<StepPostModel> postconditionSteps) {
    
    this.postconditionSteps = postconditionSteps;
    return this;
  }

  public CreateSectionRequest addPostconditionStepsItem(StepPostModel postconditionStepsItem) {
  ...
  **/
  ...
  public CreateSectionRequest attachments(List<AttachmentPutModel> attachments) {
    
    this.attachments = attachments;
    return this;
  }

  public CreateSectionRequest addAttachmentsItem(AttachmentPutModel attachmentsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createSectionRequest.name) &&
        Objects.equals(this.projectId, createSectionRequest.projectId) &&
        Objects.equals(this.parentId, createSectionRequest.parentId) &&
        Objects.equals(this.preconditionSteps, createSectionRequest.preconditionSteps) &&
        Objects.equals(this.postconditionSteps, createSectionRequest.postconditionSteps) &&
        Objects.equals(this.attachments, createSectionRequest.attachments);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSectionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateSectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSectionRequest is not found in the empty JSON string", CreateSectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateSectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSectionRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSectionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSectionRequest>() {
           @Override
           public void write(JsonWriter out, CreateSectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSectionRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateSectionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateSectionRequest
  * @throws IOException if the JSON string is invalid with respect to CreateSectionRequest
  */
  public static CreateSectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSectionRequest.class);
  }

 /**
  * Convert an instance of CreateSectionRequest to an JSON string
  *
  * @return JSON string
  */
