...
public class CustomAttributeTemplateModel {
  ...
  public CustomAttributeTemplateModel id(@jakarta.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public CustomAttributeTemplateModel isDeleted(@jakarta.annotation.Nonnull Boolean isDeleted) {
  ...
  public CustomAttributeTemplateModel name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
