...
public class FilterModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdDate, hashCodeNullable(modifiedDate), createdById, hashCodeNullable(modifiedById), hashCodeNullable(data), projectId, hashCodeNullable(fieldsToShow), hashCodeNullable(name), id, isDeleted);
  }
