 ...
 */
@JsonPropertyOrder({
  GetAIServiceModelsApiModel.JSON_PROPERTY_INQUIRY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class GetAIServiceModelsApiModel {
  ...
  public GetAIServiceModelsApiModel() { 
  }

  public GetAIServiceModelsApiModel inquiry(@jakarta.annotation.Nullable Inquiry inquiry) {
  ...
  /**
   * Return true if this GetAIServiceModelsApiModel object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetAIServiceModelsApiModel getAIServiceModelsApiModel = (GetAIServiceModelsApiModel) o;
    return equalsNullable(this.inquiry, getAIServiceModelsApiModel.inquiry);
  }
