...
public class Link {
  ...
  public Link id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public Link description(@javax.annotation.Nullable String description) {
  ...
  public Link type(@javax.annotation.Nullable LinkType type) {
    this.type = type;
    return this;
  }
  ...
  public Link hasInfo(@javax.annotation.Nonnull Boolean hasInfo) {
