...
public class LinkPutModel {
  ...
  public LinkPutModel id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public LinkPutModel title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public LinkPutModel url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public LinkPutModel description(@javax.annotation.Nullable String description) {
  ...
  public LinkPutModel type(@javax.annotation.Nullable LinkType type) {
    this.type = type;
    return this;
  }
  ...
  public LinkPutModel hasInfo(@javax.annotation.Nonnull Boolean hasInfo) {
