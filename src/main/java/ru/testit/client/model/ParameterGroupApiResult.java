 ...
 */
@JsonPropertyOrder({
  ParameterGroupApiResult.JSON_PROPERTY_PARAMETER_KEY_ID,
  ParameterGroupApiResult.JSON_PROPERTY_NAME,
...
public class ParameterGroupApiResult {
  ...
  /**
   * Return true if this ParameterGroupApiResult object is equal to o.
   */
  @Override
