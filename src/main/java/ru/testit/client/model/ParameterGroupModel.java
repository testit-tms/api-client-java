...
public class ParameterGroupModel {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ParameterGroupModel
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParameterGroupModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParameterGroupModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParameterGroupModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
