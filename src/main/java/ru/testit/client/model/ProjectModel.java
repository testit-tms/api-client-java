  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, projectModel.id) &&
        ...
        equalsNullable(this.name, projectModel.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, hashCodeNullable(description), hashCodeNullable(name), isFavorite, hashCodeNullable(attributesScheme), hashCodeNullable(testPlansAttributesScheme), hashCodeNullable(testCasesCount), hashCodeNullable(sharedStepsCount), hashCodeNullable(checkListsCount), hashCodeNullable(autoTestsCount), isDeleted, createdDate, hashCodeNullable(modifiedDate), createdById, hashCodeNullable(modifiedById), globalId);
  }
