...
public class StepPostModel {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, stepPostModel.action) &&
        Objects.equals(this.expected, stepPostModel.expected) &&
        Objects.equals(this.testData, stepPostModel.testData) &&
        Objects.equals(this.comments, stepPostModel.comments) &&
        Objects.equals(this.workItemId, stepPostModel.workItemId);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StepPostModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StepPostModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StepPostModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StepPostModel.class));

       return (TypeAdapter<T>) new TypeAdapter<StepPostModel>() {
           @Override
           public void write(JsonWriter out, StepPostModel value) throws IOException {
