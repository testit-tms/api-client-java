...
public class TagSelectModel {
  ...
  public boolean equals(Object o) {
    ...
    TagSelectModel tagSelectModel = (TagSelectModel) o;
    return Objects.equals(this.filter, tagSelectModel.filter) &&
        Objects.equals(this.extractionModel, tagSelectModel.extractionModel);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagSelectModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagSelectModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagSelectModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagSelectModel.class));

       return (TypeAdapter<T>) new TypeAdapter<TagSelectModel>() {
           @Override
           public void write(JsonWriter out, TagSelectModel value) throws IOException {
