...
public class TestPlanShortModel {
  ...
  public TestPlanShortModel id(@jakarta.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public TestPlanShortModel projectId(@jakarta.annotation.Nonnull UUID projectId) {
  ...
  public TestPlanShortModel name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
