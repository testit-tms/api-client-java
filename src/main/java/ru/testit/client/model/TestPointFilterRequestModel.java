...
public class TestPointFilterRequestModel {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.testPlanIds, testPointFilterRequestModel.testPlanIds) &&
        Objects.equals(this.testSuiteIds, testPointFilterRequestModel.testSuiteIds) &&
        Objects.equals(this.workItemGlobalIds, testPointFilterRequestModel.workItemGlobalIds) &&
        Objects.equals(this.workItemMedianDuration, testPointFilterRequestModel.workItemMedianDuration) &&
        Objects.equals(this.workItemIsDeleted, testPointFilterRequestModel.workItemIsDeleted) &&
        ...
        Objects.equals(this.testerIds, testPointFilterRequestModel.testerIds) &&
        Objects.equals(this.duration, testPointFilterRequestModel.duration) &&
        Objects.equals(this.sectionIds, testPointFilterRequestModel.sectionIds) &&
        Objects.equals(this.createdDate, testPointFilterRequestModel.createdDate) &&
        Objects.equals(this.createdByIds, testPointFilterRequestModel.createdByIds) &&
        Objects.equals(this.modifiedDate, testPointFilterRequestModel.modifiedDate) &&
        Objects.equals(this.modifiedByIds, testPointFilterRequestModel.modifiedByIds) &&
        Objects.equals(this.tags, testPointFilterRequestModel.tags) &&
        Objects.equals(this.attributes, testPointFilterRequestModel.attributes) &&
        Objects.equals(this.workItemCreatedDate, testPointFilterRequestModel.workItemCreatedDate) &&
        Objects.equals(this.workItemCreatedByIds, testPointFilterRequestModel.workItemCreatedByIds) &&
        Objects.equals(this.workItemModifiedDate, testPointFilterRequestModel.workItemModifiedDate) &&
        Objects.equals(this.workItemModifiedByIds, testPointFilterRequestModel.workItemModifiedByIds);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestPointFilterRequestModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestPointFilterRequestModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestPointFilterRequestModel is not found in the empty JSON string", TestPointFilterRequestModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestPointFilterRequestModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestPointFilterRequestModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestPointFilterRequestModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestPointFilterRequestModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestPointFilterRequestModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestPointFilterRequestModel.class));

       return (TypeAdapter<T>) new TypeAdapter<TestPointFilterRequestModel>() {
           @Override
           public void write(JsonWriter out, TestPointFilterRequestModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestPointFilterRequestModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestPointFilterRequestModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestPointFilterRequestModel
   * @throws IOException if the JSON string is invalid with respect to TestPointFilterRequestModel
   */
  public static TestPointFilterRequestModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestPointFilterRequestModel.class);
  }

  /**
   * Convert an instance of TestPointFilterRequestModel to an JSON string
   *
   * @return JSON string
   */
