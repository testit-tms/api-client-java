...
public class TestResultModel {
  ...
  private JsonNullable<AutoTestModel> autoTest = JsonNullable.<AutoTestModel>undefined();
  ...
  **/
  ...
  public TestResultModel autoTest(AutoTestModel autoTest) {
    this.autoTest = JsonNullable.<AutoTestModel>of(autoTest);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<AutoTestModel> getAutoTest_JsonNullable() {
    return autoTest;
  }
  
  @JsonProperty(JSON_PROPERTY_AUTO_TEST)
  public void setAutoTest_JsonNullable(JsonNullable<AutoTestModel> autoTest) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.autoTestId, testResultModel.autoTestId) &&
        ...
        equalsNullable(this.testPoint, testResultModel.testPoint) &&
        equalsNullable(this.autoTest, testResultModel.autoTest) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(autoTestId), configurationId, hashCodeNullable(startedOn), hashCodeNullable(completedOn), hashCodeNullable(durationInMs), hashCodeNullable(traces), hashCodeNullable(failureType), hashCodeNullable(message), hashCodeNullable(runByUserId), hashCodeNullable(stoppedByUserId), testPointId, testRunId, hashCodeNullable(testPoint), hashCodeNullable(autoTest), hashCodeNullable(autoTestStepResults), hashCodeNullable(setupResults), hashCodeNullable(teardownResults), workItemVersionId, hashCodeNullable(workItemVersionNumber), hashCodeNullable(parameters), hashCodeNullable(properties), id, createdDate, hashCodeNullable(modifiedDate), createdById, hashCodeNullable(modifiedById), hashCodeNullable(stepComments), hashCodeNullable(failureClassIds), hashCodeNullable(outcome), hashCodeNullable(comment), hashCodeNullable(links), hashCodeNullable(stepResults), hashCodeNullable(attachments));
  }
