...
public class TestResultsFilterRequest {
  ...
  public TestResultsFilterRequest() {
  }

  public TestResultsFilterRequest configurationIds(List<UUID> configurationIds) {
    
    this.configurationIds = configurationIds;
    return this;
  }

  public TestResultsFilterRequest addConfigurationIdsItem(UUID configurationIdsItem) {
  ...
  **/
  ...
  @Deprecated
  public TestResultsFilterRequest outcomes(List<TestResultOutcome> outcomes) {
    
    this.outcomes = outcomes;
    return this;
  }

  public TestResultsFilterRequest addOutcomesItem(TestResultOutcome outcomesItem) {
  ...
  **/
  ...
  public TestResultsFilterRequest statusCodes(List<String> statusCodes) {
    
    this.statusCodes = statusCodes;
    return this;
  }

  public TestResultsFilterRequest addStatusCodesItem(String statusCodesItem) {
  ...
  **/
  ...
  public TestResultsFilterRequest failureCategories(List<FailureCategoryModel> failureCategories) {
    
    this.failureCategories = failureCategories;
    return this;
  }

  public TestResultsFilterRequest addFailureCategoriesItem(FailureCategoryModel failureCategoriesItem) {
  ...
  **/
  ...
  public TestResultsFilterRequest namespace(String namespace) {
  ...
  **/
  ...
  public TestResultsFilterRequest className(String className) {
  ...
  **/
  ...
  public TestResultsFilterRequest autoTestGlobalIds(List<Long> autoTestGlobalIds) {
    
    this.autoTestGlobalIds = autoTestGlobalIds;
    return this;
  }

  public TestResultsFilterRequest addAutoTestGlobalIdsItem(Long autoTestGlobalIdsItem) {
  ...
  **/
  ...
  public TestResultsFilterRequest name(String name) {
  ...
  **/
  ...
  public TestResultsFilterRequest createdDate(TestResultsFilterRequestCreatedDate createdDate) {
  ...
  **/
  ...
  public TestResultsFilterRequest modifiedDate(TestResultsFilterRequestModifiedDate modifiedDate) {
  ...
  **/
  ...
  public TestResultsFilterRequest startedOn(TestResultsFilterRequestStartedOn startedOn) {
  ...
  **/
  ...
  public TestResultsFilterRequest completedOn(TestResultsFilterRequestCompletedOn completedOn) {
  ...
  **/
  ...
  public TestResultsFilterRequest duration(TestResultsFilterRequestDuration duration) {
  ...
  **/
  ...
  public TestResultsFilterRequest resultReasons(List<String> resultReasons) {
    
    this.resultReasons = resultReasons;
    return this;
  }

  public TestResultsFilterRequest addResultReasonsItem(String resultReasonsItem) {
  ...
  **/
  ...
  public TestResultsFilterRequest testRunIds(List<UUID> testRunIds) {
    
    this.testRunIds = testRunIds;
    return this;
  }

  public TestResultsFilterRequest addTestRunIdsItem(UUID testRunIdsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TestResultsFilterRequest testResultsFilterRequest = (TestResultsFilterRequest) o;
    return Objects.equals(this.configurationIds, testResultsFilterRequest.configurationIds) &&
        Objects.equals(this.outcomes, testResultsFilterRequest.outcomes) &&
        Objects.equals(this.statusCodes, testResultsFilterRequest.statusCodes) &&
        Objects.equals(this.failureCategories, testResultsFilterRequest.failureCategories) &&
        Objects.equals(this.namespace, testResultsFilterRequest.namespace) &&
        Objects.equals(this.className, testResultsFilterRequest.className) &&
        Objects.equals(this.autoTestGlobalIds, testResultsFilterRequest.autoTestGlobalIds) &&
        Objects.equals(this.name, testResultsFilterRequest.name) &&
        Objects.equals(this.createdDate, testResultsFilterRequest.createdDate) &&
        Objects.equals(this.modifiedDate, testResultsFilterRequest.modifiedDate) &&
        Objects.equals(this.startedOn, testResultsFilterRequest.startedOn) &&
        Objects.equals(this.completedOn, testResultsFilterRequest.completedOn) &&
        Objects.equals(this.duration, testResultsFilterRequest.duration) &&
        Objects.equals(this.resultReasons, testResultsFilterRequest.resultReasons) &&
        Objects.equals(this.testRunIds, testResultsFilterRequest.testRunIds);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TestResultsFilterRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TestResultsFilterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestResultsFilterRequest is not found in the empty JSON string", TestResultsFilterRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TestResultsFilterRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestResultsFilterRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestResultsFilterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestResultsFilterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestResultsFilterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestResultsFilterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestResultsFilterRequest>() {
           @Override
           public void write(JsonWriter out, TestResultsFilterRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestResultsFilterRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TestResultsFilterRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TestResultsFilterRequest
  * @throws IOException if the JSON string is invalid with respect to TestResultsFilterRequest
  */
  public static TestResultsFilterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestResultsFilterRequest.class);
  }

 /**
  * Convert an instance of TestResultsFilterRequest to an JSON string
  *
  * @return JSON string
  */
