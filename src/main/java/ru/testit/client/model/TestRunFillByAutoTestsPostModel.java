...
public class TestRunFillByAutoTestsPostModel {
  ...
  **/
  ...
  public TestRunFillByAutoTestsPostModel attachments(List<AttachmentPutModel> attachments) {
    this.attachments = attachments;
    return this;
  }

  public TestRunFillByAutoTestsPostModel addAttachmentsItem(AttachmentPutModel attachmentsItem) {
  ...
  **/
  ...
  public TestRunFillByAutoTestsPostModel links(List<LinkPostModel> links) {
    this.links = links;
    return this;
  }

  public TestRunFillByAutoTestsPostModel addLinksItem(LinkPostModel linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.projectId, testRunFillByAutoTestsPostModel.projectId) &&
        ...
        Objects.equals(this.attachments, testRunFillByAutoTestsPostModel.attachments) &&
        Objects.equals(this.links, testRunFillByAutoTestsPostModel.links);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to TestRunFillByAutoTestsPostModel
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestRunFillByAutoTestsPostModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestRunFillByAutoTestsPostModel is not found in the empty JSON string", TestRunFillByAutoTestsPostModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestRunFillByAutoTestsPostModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestRunFillByAutoTestsPostModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestRunFillByAutoTestsPostModel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestRunFillByAutoTestsPostModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestRunFillByAutoTestsPostModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestRunFillByAutoTestsPostModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestRunFillByAutoTestsPostModel.class));

       return (TypeAdapter<T>) new TypeAdapter<TestRunFillByAutoTestsPostModel>() {
           @Override
           public void write(JsonWriter out, TestRunFillByAutoTestsPostModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestRunFillByAutoTestsPostModel read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TestRunFillByAutoTestsPostModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TestRunFillByAutoTestsPostModel
  * @throws IOException if the JSON string is invalid with respect to TestRunFillByAutoTestsPostModel
  */
  public static TestRunFillByAutoTestsPostModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestRunFillByAutoTestsPostModel.class);
  }

 /**
  * Convert an instance of TestRunFillByAutoTestsPostModel to an JSON string
  *
  * @return JSON string
  */
