...
public class TestRunModel {
  ...
  private JsonNullable<TestRunAnalyticResultModel> analytic = JsonNullable.<TestRunAnalyticResultModel>undefined();
  ...
  private JsonNullable<TestPlanModel> testPlan = JsonNullable.<TestPlanModel>undefined();
  ...
  **/
  ...
  public TestRunModel analytic(TestRunAnalyticResultModel analytic) {
    this.analytic = JsonNullable.<TestRunAnalyticResultModel>of(analytic);
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ANALYTIC)
  public void setAnalytic_JsonNullable(JsonNullable<TestRunAnalyticResultModel> analytic) {
  ...
  **/
  ...
  public TestRunModel testPlan(TestPlanModel testPlan) {
    this.testPlan = JsonNullable.<TestPlanModel>of(testPlan);
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_TEST_PLAN)
  public void setTestPlan_JsonNullable(JsonNullable<TestPlanModel> testPlan) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.autoTests, testRunModel.autoTests) &&
        ...
        equalsNullable(this.analytic, testRunModel.analytic) &&
        equalsNullable(this.testResults, testRunModel.testResults) &&
        equalsNullable(this.testPlan, testRunModel.testPlan) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(autoTests), autoTestsCount, hashCodeNullable(testSuiteIds), isAutomated, hashCodeNullable(analytic), hashCodeNullable(testResults), hashCodeNullable(testPlan), createdDate, hashCodeNullable(modifiedDate), createdById, hashCodeNullable(modifiedById), hashCodeNullable(createdByUserName), hashCodeNullable(startedDate), hashCodeNullable(completedDate), hashCodeNullable(build), hashCodeNullable(description), stateName, projectId, hashCodeNullable(testPlanId), hashCodeNullable(runByUserId), hashCodeNullable(stoppedByUserId), hashCodeNullable(name), hashCodeNullable(launchSource), id, isDeleted);
  }
