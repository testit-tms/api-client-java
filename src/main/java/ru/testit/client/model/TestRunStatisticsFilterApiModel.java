...
public class TestRunStatisticsFilterApiModel {
  ...
  public TestRunStatisticsFilterApiModel configurationIds(@javax.annotation.Nullable List<UUID> configurationIds) {
  ...
  @Deprecated
  public TestRunStatisticsFilterApiModel outcomes(@javax.annotation.Nullable List<TestResultOutcome> outcomes) {
  ...
  public TestRunStatisticsFilterApiModel statusCodes(@javax.annotation.Nullable List<String> statusCodes) {
  ...
  public TestRunStatisticsFilterApiModel failureCategories(@javax.annotation.Nullable List<FailureCategoryModel> failureCategories) {
  ...
  public TestRunStatisticsFilterApiModel namespace(@javax.annotation.Nullable String namespace) {
  ...
  public TestRunStatisticsFilterApiModel className(@javax.annotation.Nullable String className) {
