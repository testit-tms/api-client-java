 ...
 */
@JsonPropertyOrder({
  TestRunTestResultsSelectModelFilter.JSON_PROPERTY_CONFIGURATION_IDS,
  TestRunTestResultsSelectModelFilter.JSON_PROPERTY_OUTCOMES,
  TestRunTestResultsSelectModelFilter.JSON_PROPERTY_FAILURE_CATEGORIES,
  TestRunTestResultsSelectModelFilter.JSON_PROPERTY_NAMESPACE,
  TestRunTestResultsSelectModelFilter.JSON_PROPERTY_CLASS_NAME
})
@JsonTypeName("TestRunTestResultsSelectModel_filter")
...
public class TestRunTestResultsSelectModelFilter {
  ...
  **/
  ...
  /**
   * Return true if this TestRunTestResultsSelectModel_filter object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.configurationIds, testRunTestResultsSelectModelFilter.configurationIds) &&
        equalsNullable(this.outcomes, testRunTestResultsSelectModelFilter.outcomes) &&
        equalsNullable(this.failureCategories, testRunTestResultsSelectModelFilter.failureCategories) &&
        equalsNullable(this.namespace, testRunTestResultsSelectModelFilter.namespace) &&
        equalsNullable(this.className, testRunTestResultsSelectModelFilter.className);
  }
