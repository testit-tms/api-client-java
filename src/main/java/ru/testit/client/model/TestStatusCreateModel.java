...
public class TestStatusCreateModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TestStatusCreateModel testStatusCreateModel = (TestStatusCreateModel) o;
    return Objects.equals(this.name, testStatusCreateModel.name) &&
        Objects.equals(this.type, testStatusCreateModel.type) &&
        Objects.equals(this.code, testStatusCreateModel.code) &&
        Objects.equals(this.description, testStatusCreateModel.description);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestStatusCreateModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestStatusCreateModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestStatusCreateModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestStatusCreateModel.class));

       return (TypeAdapter<T>) new TypeAdapter<TestStatusCreateModel>() {
           @Override
           public void write(JsonWriter out, TestStatusCreateModel value) throws IOException {
