...
public class WebhooksDeleteRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhooksDeleteRequest webhooksDeleteRequest = (WebhooksDeleteRequest) o;
    return Objects.equals(this.filter, webhooksDeleteRequest.filter) &&
        Objects.equals(this.extractor, webhooksDeleteRequest.extractor);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksDeleteRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksDeleteRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksDeleteRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksDeleteRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksDeleteRequest>() {
           @Override
           public void write(JsonWriter out, WebhooksDeleteRequest value) throws IOException {
