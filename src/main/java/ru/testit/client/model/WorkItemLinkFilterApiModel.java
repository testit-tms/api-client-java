 ...
 */
@JsonPropertyOrder({
  WorkItemLinkFilterApiModel.JSON_PROPERTY_TYPES,
  WorkItemLinkFilterApiModel.JSON_PROPERTY_TITLE,
...
public class WorkItemLinkFilterApiModel {
  ...
  public WorkItemLinkFilterApiModel addTypesItem(LinkType typesItem) {
    if (this.types == null || !this.types.isPresent()) {
      this.types = JsonNullable.<Set<LinkType>>of(new LinkedHashSet<>());
    }
    try {
  ...
  public JsonNullable<Set<LinkType>> getTypes_JsonNullable() {
    return types;
  }
  
  @JsonProperty(JSON_PROPERTY_TYPES)
  public void setTypes_JsonNullable(JsonNullable<Set<LinkType>> types) {
    this.types = types;
  }
  ...
  /**
   * Return true if this WorkItemLinkFilterApiModel object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.types, workItemLinkFilterApiModel.types) &&
        equalsNullable(this.title, workItemLinkFilterApiModel.title) &&
        equalsNullable(this.urls, workItemLinkFilterApiModel.urls) &&
        equalsNullable(this.onlyWithoutLinks, workItemLinkFilterApiModel.onlyWithoutLinks);
  }
