 ...
 */
@JsonPropertyOrder({
  WorkItemsExtractionModelIds.JSON_PROPERTY_INCLUDE,
  WorkItemsExtractionModelIds.JSON_PROPERTY_EXCLUDE
})
@JsonTypeName("WorkItemsExtractionModel_ids")
...
public class WorkItemsExtractionModelIds {
  ...
  public WorkItemsExtractionModelIds include(List<UUID> include) {
  ...
  **/
  ...
  public WorkItemsExtractionModelIds exclude(List<UUID> exclude) {
  ...
  **/
  ...
  /**
   * Return true if this WorkItemsExtractionModel_ids object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.include, workItemsExtractionModelIds.include) &&
        equalsNullable(this.exclude, workItemsExtractionModelIds.exclude);
  }
