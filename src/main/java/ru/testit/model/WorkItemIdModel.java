...
public class WorkItemIdModel {
   ...
   * @return id
  **/
  @Schema(example = "9891bb36-71eb-4a4a-a049-eae838db9514", description = "Used for search WorkItem. Internal identifier has a Guid data format. Global identifier has an integer data format")
  public String getId() {
    return id;
  }
