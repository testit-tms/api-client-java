...
public class TestPointShortResponseModelTest {

    // in a case of failure:
    // Solution: -> TestPointShortResponseModel
    // Change this:
    ...
    private JsonObject setupValidModelJsonObject() {
        ...
        TestPointShortResponseModel.openapiFields = new HashSet<>(Arrays.asList(
                ...
                "sectionId", "sectionName", "projectId", "lastTestResult", "iterationId", "sourceType",
        ...
        TestPointShortResponseModel.openapiRequiredFields = new HashSet<>(Arrays.asList(
                ...
                "lastTestResult", "iterationId", "sourceType", "workItemCreatedById", "status", "priority", "workItemState"
        ));
